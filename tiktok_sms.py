...
# ============================================================
# PUZZLE SOLVER (from solver.py — complete)
# ============================================================
...
# ============================================================
# CAPTCHA SOLVER (adapted from solver.py + 3D support)
# ============================================================
...
class TikTokClient:
    ...
    def send_code(self, phone, sms_type=33):
        ...
        try:
            ...
            if ec in (1105, 1107):
                # Parse captcha conf from verify_center_decision_conf
                conf = {}
